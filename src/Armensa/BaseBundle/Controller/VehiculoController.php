...
use Armensa\BaseBundle\Entity\Vehiculo;
use Armensa\BaseBundle\Form\VehiculoType;
...
class VehiculoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ArmensaBaseBundle:Vehiculo')->findAll();
     ...
     * @Method("POST")
     * @Template("ArmensaBaseBundle:Vehiculo:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ArmensaBaseBundle:Vehiculo')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ArmensaBaseBundle:Vehiculo:edit.html.twig")
     */
