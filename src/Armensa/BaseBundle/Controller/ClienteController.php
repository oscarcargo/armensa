...
use Armensa\BaseBundle\Entity\Cliente;
use Armensa\BaseBundle\Form\ClienteType;
...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ArmensaBaseBundle:Cliente')->findAll();
     ...
     * @Method("POST")
     * @Template("ArmensaBaseBundle:Cliente:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ArmensaBaseBundle:Cliente')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ArmensaBaseBundle:Cliente:edit.html.twig")
     */
